...
public class AbreTelaConsultarHierarquia {
	...
	private static final String MASSA_DADOS_CODIGO_EMPRESA_SUBORDINADA = PropertiesUtils
			.getVariable("massa.dados.codigosequencia.subordinada");
	...
	public static void main(String[] args) {
		...
		telaManutencao.preencheDadosConsulta(MASSA_DADOS_CODIGO_EMPRESA_SUBORDINADA, TipoHierarquia.TESTE_EMPRESA, "2",
				"25");
